...
<![endif]-->
<script src="${pageContext.request.contextPath}/statics/assets/js/jquery.js"></script>
<script
	src="${pageContext.request.contextPath}/statics/assets/js/jquery.mCustomScrollbar.concat.min.js"></script>
<script>
	(function($) {
		$(window).load(
				function() {
...
<body>
	...
	<header>
		<h1>
			<img
				src="${pageContext.request.contextPath}/statics/assets/images/admin_logo.png" />
		</h1>
		<ul class="rt_nav">
